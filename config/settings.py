...
SECRET_KEY = 'django-insecure-3_ehql)jky7f)68t)5u3t0qvqfi=fe)uj+=v)sr^5(x*tocx0e'
...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',   # ← obligatoire
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ia_consulting_platform',
        'USER': 'rdkj',
        'PASSWORD': 'rene',
        'HOST': 'localhost',  # ou IP du serveur
        'PORT': '3306',       # port par défaut MySQL/MariaDB
        'OPTIONS': {
